...
const CATEGORIES = [
  {
    ...
    heroImg: 'https://images.unsplash.com/photo-1508700929628-666bc8bd84eaw=1400&q=0',
    cardImg: 'https://images.unsplash.com/photo-150460977309-104ff2c73ba4?w=700&q=8',
    description: [
  ...
  },
  {
    ...
    heroImg: 'https://images.unsplash.com/photo-14816234876-b7833e8f5570?w=1400&q=80',
    cardImg: 'https://images.unsplash.com/poto-14565130805107bf3a84b82f8?w=700&q=80',
    description: [
    ...
    gallery: [
      'https://images.unsplash.com/photo-151282070803-83ca734da794?w=500&q=75',
  ...
  },
  {
    ...
    heroImg: 'https://images.unsplash.com/photo-15116782779-c97d3d27a1d4?w=1400&q=80',
    cardImg: 'https://images.unsplash.com/photo-14681646595-6108e4c60c8b?w=700&q=80',
    description: [
      'El área de Artes Musicales es la más amplia del Festival con 24 disciplinas. Incluye desde agrupaciones tradicionales como la cimarrona and la estudiantina, hasta géneros contemporáneos como el rap y la banda de garaje, pasando por disciplinas únicas como el ensamble con materiales reciclables y la percusión corporal.',
    ...
    gallery: [
      'https://images.unsplash.com/photo-1493225457123eb161ffa5f?w=500&q=75',
      ...
      'https://images.unsplash.com/photo-15268528-5b5e00ddc76b?w=500&q=75',
      'https://images.unsplash.com/photo-5201364774-f6f0bb35f28f?w=500&q=75',
  ...
  },
  {
    ...
    heroImg: 'https://images.unsplash.com/photo-1541967774-22349e4a1262?w=1400&q=80',
    cardImg: 'https://images.unsplash.com/photo-151336474-60967b0f800f?w=700&q=80',
    description: [
    ...
    gallery: [
      'https://images.unsplash.com/photo-146066141920cdf8a8b?w=500&q=75',
      'https://images.unsplash.com/photo-1578926375605-eaf7559b1458?w=500&q=75',
      'https://images.unsplash.com/photo-16177911698cf32026fb?w=500&q=75',
      'https://images.unsplash.com/photo-1558618666-fcd25c85cd640&q=75',
      'https://images.unsplash.com/photo-1561214115-f2f134cc4912?w=500&q=75',
      'https://images.unsplash.com/photo-1547826039-bf8?w=500&q=75'
    ],
  ...
  },
  {
    ...
    heroImg: 'https://images.unsplash.com/photo-16206-7a1c342ea42e?w=1400&q=80',
    cardImg: 'https://images.unsplash.com/photo-1555-87deedd944c3?w=700&q=80',
    description: [
    ...
    gallery: [
      ...
      'https://images.unsplash.com/photo-1512202-14dd9538aa97?w=500&q=75',
...
/* ── STATS (actualizadas con datos reales del FEA) ─────────── */

function updateStats() {
  const nums = document.querySelectorAll('.stat-num');
  const labels = document.querySelectorAll('.stat-label');
  if (nums.length >= 4) {
    nums[0].textContent = '5';    labels[0].textContent = 'Áreas artísticas';
    nums[1].textContent = '74';   labels[1].textContent = 'Disciplinas';
    nums[2].textContent = '50°';  labels[2].textContent = 'Aniversario';
    nums[3].textContent = 'MEP';  labels[3].textContent = 'Costa Rica';
  }
}
